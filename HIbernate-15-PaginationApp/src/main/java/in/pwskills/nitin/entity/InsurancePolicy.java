...
@Entity
@NamedQuery(name = "GET_POLICIES_COUNT", query = "SELECT count(*) FROM in.pwskills.nitin.entity.InsurancePolicy")
@NamedQuery(name = "GET_ALL_POLICIES", query = "FROM in.pwskills.nitin.entity.InsurancePolicy")
